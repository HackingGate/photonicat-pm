 ...
 *
 * CAUTION: Current tested firmware versions expose no trusted API to reset fan
 * control back to PMU auto speed. The README Fan Control section documents the
 * user-visible limitation and restore workarounds.
 *
